...
public class KafkaPerfSimulator implements KafkaSimulatorMXBean
{
  ...
  static String kafkaServersURL = "";
  final static int kafkaServerPort = 9092;
  final static int kafkaProducerBufferSize = 64*1024;
  final static int connectionTimeOut = 100000;
  final static int reconnectInterval = 10000;
  static int messageSize = 200;
  static int fetchSize = 1024 *1024; /*1MB*/
  ...
  final static String topicExt = "_"+new Date().getTime();
  ...
  public void startProducers() throws UnknownHostException
  {
    ...
    for(int i = 0; i < numProducer; i++ )
    {
      ...
      producers[i] = new Producer(topic + topicExt,kafkaServerURL, kafkaServerPort, kafkaProducerBufferSize, connectionTimeOut, reconnectInterval,
  ...
  public void startConsumers() throws UnknownHostException
  {
    ...
    for(int i = 0; i < numConsumers; i++ )
    {
      ...
      consumers[i] = new SimplePerfConsumer(topic + topicExt,kafkaServerURL, kafkaServerPort, kafkaProducerBufferSize, connectionTimeOut, reconnectInterval,
                                  fetchSize, InetAddress.getLocalHost().getHostAddress()+ consumerName +i, random.nextInt(this.numParts));
    }
  ...
  private static void  getOptions(OptionParser parser, String[] args)
  {
    ...
    System.out.println("server: " + kafkaServersURL + " report: " + reportFileName);
