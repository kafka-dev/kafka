...
class ZKConfig(props: Properties) {
  ...
  /** the timeout for the zookeeper connection */
  val zkSessionTimeoutMs = Utils.getInt(props, "zk.sessiontimeoutms", 6000)

  /** the timeout for connecting to zookeeper */
  val zkConnectionTimeoutMs = Utils.getInt(props, "zk.connectiontimeoutms",zkSessionTimeoutMs)

  /** how far a ZK follower can be behind a ZK leader */
  val zkSyncTimeMs = Utils.getInt(props, "zk.synctimems", 2000)
}
